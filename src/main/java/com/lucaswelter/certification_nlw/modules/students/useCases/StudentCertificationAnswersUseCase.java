package com.lucaswelter.certification_nlw.modules.students.useCases;
...
import com.lucaswelter.certification_nlw.modules.students.dto.StudentCertificationAnswerDTO;
import com.lucaswelter.certification_nlw.modules.students.dto.VerifyHasCertificationDTO;
import com.lucaswelter.certification_nlw.modules.students.entities.AnswersCertificationsEntity;
import com.lucaswelter.certification_nlw.modules.students.entities.CertificationStudentEntity;
import com.lucaswelter.certification_nlw.modules.students.entities.StudentEntity;
import com.lucaswelter.certification_nlw.modules.students.repositories.CertificationStudentRepository;
import com.lucaswelter.certification_nlw.modules.students.repositories.StudentRepository;
...
public class StudentCertificationAnswersUseCase {
    ...
    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception{
        ...
        dto.getQuestionsAnswers().stream().forEach(questionAnswer -> {
            ...
            var findCorrectAlternative = question.getAlternatives().stream().filter(alternative -> 
        ...
        CertificationStudentEntity.builder().technology(dto.getTechnology()).studentID(studentID).grade(correctAnswers.get())
        .build();
